...
public class ChessDriver {
    ...
    private static void moveOption(Board b) {
        ...
        System.out.println("It is " + (b.getIsWhiteTurn() ? "White" : "Black")
                + " 's Turn.");
        ...
        try {
            ...
            try {
                ...
                // Second chance only for InvalidMoveException
                System.out.print("Select a valid location to move to: ");
                int newX2 = kbd.nextInt();
                int newY2 = kbd.nextInt();

                try {
                    b.move(x1, y1, newX2, newY2);
                } catch (ChessException e2) {
                    System.out.println("Move failed again." + e2.getMessage());
                }
