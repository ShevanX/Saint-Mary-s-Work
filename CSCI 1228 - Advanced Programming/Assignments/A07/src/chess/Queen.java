...
public class Queen extends Piece {
    ...
    public Queen(Board board, boolean color, int col, int row) {
    ...
    public boolean isValidMove(int fromCol, int fromRow, int toCol, int toRow) {
        ...
        boolean straight = (fromCol == toCol || fromRow == toRow);
        boolean diagonal = (Math.abs(toCol - fromCol) == Math.abs(toRow - 
                fromRow));
