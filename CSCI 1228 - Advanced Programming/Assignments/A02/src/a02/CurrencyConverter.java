...
public class CurrencyConverter {
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 0) {
            ...
            System.out.println("This program converts EUR, USD, and JPY "
                    + "currency to CAD.");
            System.out.println("Input format: 12.50USD or 0.99eur etc.");
            System.out.println("Each input must end with a valid currency "
                    + "code and contain two decimal digits.");
        ...
        for(String num: args){
            boolean isValid = checkValidity(num);
            double converted = 0.0;
            
            converted = convert(isValid, num);
            
            
            getOutput(isValid, converted, num);
        }
    ...
    private static boolean checkValidity(String num) {
     ...
     */
    private static double convert(boolean allDigits, String num){
        double converted = 0.0;
        if(allDigits){
     ...
     */
    private static void getOutput(boolean allDigits, double converted, 
            String num){
        if(allDigits){
